...
- *This tutorial assumes that the reader is working on *nix system, say, Ubuntu, Debain, macOS, etc. This is evident if you skim through the table of content and read the chapters on grep (Windows does NOT has that magic!)*
